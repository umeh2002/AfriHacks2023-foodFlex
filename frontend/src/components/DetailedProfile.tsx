      ...
      <div className="w-full h-[125px] flex p-3 bg-red-500">
        ...
        <div className="w-[80%] h-full text-white ml-3">
          <div className="flex justify-between">
            <div className="capitalize font-semibold text-[20px]">
              Chidera Okoro
            </div>
          ...
          <div className="text-[11.3px] leading-3">cfoonyemmemme@gmail.com</div>
          <div className="text-[11.3px] leading-5">+2348136039861</div>
          <div className="flex text-center">
            <div className="mr-10">
              <div className="text-[20px] font-semibold">₦3, 000.00</div>
